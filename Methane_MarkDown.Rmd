...
relitive_function<- function(yearask, var) {
...
lap_Co2Concentration<- lapply(as.list(2000:2100), relitive_function, "CO2_concentration")
Rel_Co2Concentration<- bind_rows(lap_Co2Concentration)

lap_RF_tot<- lapply(as.list(2000:2100), relitive_function, "RF_tot")
Rel_RF_tot<- bind_rows(lap_RF_tot)

lap_RF_CO2<- lapply(as.list(2000:2100), relitive_function, "RF_CO2")
Rel_RF_CO2<- bind_rows(lap_RF_CO2)

lap_global_tas<- lapply(as.list(2000:2100), relitive_function, "global_tas")
