...
ggplot(data= results, aes(x= year, y= value, color= units))+
    ...
    labs(x = "year",
         y = NULL,
         title = "Methane Concentrations and Emissions 1745-2100 in SSP245",
...
ggplot(sensitivity_emission) +
  ...
  labs(color = ("Natural CH4 (Tg)"), title = "Natural Methane Sensitivity Analysis") +
...
ggplot(data, aes(x=value))+
  geom_histogram(binwidth = 10, color="red", fill="blue")+
  labs( x= "Natural CH4 Level", y= "count", main= "Natural Methane Histogram")
```
...
long_fdata %>%
  ...
  labs(title = "Methane Sensitivity Analysis Histogram: Multiple Parameters")
```
...
ggplot(headlong, aes(y= param_value, x= run_number , fill= parameter )) +
  ...
  labs(title = "Methane Sensitivity Analysis Barchart: Multiple Parameters")+
  scale_fill_brewer(palette="Set1")
```
...
ggplot(full_data, aes(y= value, x=  year, color= run_number, group = run_number)) +
  ...
  labs(title = "Methane Sensitivity Analysis: Multiple Parameters")
```
...
ggplot(sum_data, aes(year)) +
  ...
  theme(legend.position= "none")+
  scale_fill_brewer(palette="Set1")+
  labs(y= "mean value", x= "year", title = "Methane Sensitivity Summary: Multiple Parameters")
...
ggplot(exp_data, aes(year)) +
  ...
  facet_wrap(~variable, scales = "free_y")+
  labs( title= "Multiple Parameters vs Natural Methane Sensitivity", y= "mean")+
  scale_fill_brewer(palette="Set1")
```
